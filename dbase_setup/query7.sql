...
BEGIN
	   ...
	   FROM Education)
	   SELECT avgTeacherStartingSalary, FORMAT((-avgStats.avgHS + highschoolGradRate), 3) AS 'hsDeviation', FORMAT((-avgStats.avgCollege + percentCompletingCollege), 3) AS 'collegeDeviation'
